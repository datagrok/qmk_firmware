...
enum layers { qwerty, colemak, dvorak, workman, red, blu, pur };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        ...
        MO(blu),         KC_HENK, KC_SCLN, KC_LGUI, KC_TAB,  MO(red), MO(red), KC_SPC,    KC_RGUI, KC_UNDS, KC_MHEN, MO(blu)),
    LAYOUT(
    ...
    LAYOUT(
        ...
        _______,         _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, _______),
    LAYOUT(
        LALT_T(KC_Q),    KC_D,    KC_R,    KC_W,    KC_B,    /*,      ,        */KC_J,    KC_F,    KC_U,    KC_P,    RALT_T(KC_MINS),
        ...
        _______,         _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, _______),
    LAYOUT(
        KC_ESC,          KC_GRV , KC_UP,   KC_TILD, _______, /*,      ,        */KC_PLUS, KC_CIRC, KC_AMPR, KC_PERC, KC_MINS,
        KC_BSPC,         KC_LEFT, KC_DOWN, KC_RGHT, KC_PIPE, /*,      ,        */KC_EQL,  KC_AT,   KC_DLR,  KC_HASH, KC_ENT,
        KC_BSLS,         KC_LABK, KC_LCBR, KC_LPRN, KC_LBRC, /*,      ,        */KC_RBRC, KC_RPRN, KC_RCBR, KC_RABK, KC_SLSH,
        TT(pur),         _______, _______, _______, _______, _______, _______, _______,   _______, KC_DEL,  _______, TT(pur)),
    LAYOUT(
        _______,         KC_F1,   KC_F2,   KC_F3,   KC_F4,   /*,      ,        */KC_PLUS, KC_7,    KC_8,    KC_9,    KC_MINS,
        KC_BSPC,         KC_F5,   KC_F6,   KC_F7,   KC_F8,   /*,      ,        */KC_EQL,  KC_4,    KC_5,    KC_6,    KC_ENT,
        _______,         KC_F9,   KC_F10,  KC_F11,  KC_F12,  /*,      ,        */KC_ASTR, KC_1,    KC_2,    KC_3,    KC_SLSH,
        _______,         _______, _______, _______, _______, TT(pur), TT(pur), _______,   KC_0,    KC_DOT,  _______, _______),
    LAYOUT(
        RESET,           KC_INS,  KC_PGUP, DEBUG,   KC_VOLU, /*,      ,        */KC_PPLS, KC_P7,   KC_P8,   KC_P9,   KC_PMNS,
        _______,         KC_HOME, KC_PGDN, KC_END,  KC_VOLD, /*,      ,        */KC_PEQL, KC_P4,   KC_P5,   KC_P6,   KC_PENT,
